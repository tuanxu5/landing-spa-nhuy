...
- [ ] 1. Set up backend infrastructure and database connection
...
- [ ] 2. Implement booking data models and API
  - [ ] 2.1 Create booking schema and DTOs
  ...
  - [ ] 2.2 Implement bookings service
  ...
  - [ ] 2.3 Create bookings controller and routes
  ...
  - [ ] 2.4 Write unit tests for bookings service
...
- [ ] 3. Implement authentication system
  - [ ] 3.1 Create administrator schema and session schema
  ...
  - [ ] 3.3 Create authentication guard
  ...
  - [ ] 3.4 Create authentication controller and routes
...
- [ ] 4. Checkpoint - Ensure backend authentication and bookings work
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 5. Implement posts/content management system
  - [ ] 5.1 Create post schema and DTOs
  ...
  - [ ] 5.3 Create posts controller and routes
  ...
  - [ ] 5.4 Write unit tests for posts service
    - Test `create()` with valid and invalid data
